...
namespace SearchTK
{
    public class Tests
    {
        ...
        public void EditWithExcelData()
        {
            ...
            string excelFilePath = @"C:\Users\Admin\Desktop\SearchTK\Search.xlsx";
            // Load Excel file
            ...
            using (ExcelPackage package = new ExcelPackage(fileInfo))
            {
                ...
                for (int row = 2; row <= worksheet.Dimension.Rows; row++)
                {
                    ...
                    try
                    {
                        IWebElement ketqua = driver.FindElement(By.CssSelector("a[href='/Admin/User/Edit/12']"));
                        ketqua.Click();
        ...
        {
            string filePath = @"C:\Users\Admin\Desktop\SearchTK\Search.xlsx";
        ...
        private void SearchTK(string email, string password, string keywords)
        {
            ...
            Thread.Sleep(1000);
            driver.FindElement(By.CssSelector("li:nth-child(3) > .active > span:nth-child(2)")).Click();
            Thread.Sleep(1000);
