...
namespace TaoCV
{
    public class Tests
    {
        ...
        public void EditWithExcelData()
        {
            ...
            string excelFilePath = @"C:\Users\Admin\Desktop\TaoCV\TaoCV.xlsx";
            // Load Excel file
            ...
            using (ExcelPackage package = new ExcelPackage(fileInfo))
            {
                ...
                for (int row = 2; row <= worksheet.Dimension.Rows; row++)
                {
                    ...
                    TaoHoSo(emailInput, passwordInput, nameCVInput, baccvInput, chuyennganhInput, loaiCVInput, muctieuInput, kinhnghiemInput, kinangInput, hocvanInput, kinangmemInput, giaithuongInput);
        ...
        {
            string filePath = @"C:\Users\Admin\Desktop\TaoCV\TaoCV.xlsx";
        ...
        private void TaoHoSo(string email, string password, string tenhs, string baccv, string chuyennganh, string loaicv, string muctieu, string exp, string kinang, string hocvan, string kinangmem, string giaithuong)
        {
            ...
            Thread.Sleep(1000);
            driver.FindElement(By.LinkText("Tạo CV")).Click();
            Thread.Sleep(2000);
            IWebElement TenHS = driver.FindElement(By.Id("TenHoSo"));
            TenHS.Clear();
            TenHS.Click();
            TenHS.SendKeys(tenhs);
            Thread.Sleep(1000);

            driver.FindElement(By.CssSelector(".col-md-4:nth-child(1) .filter-option-inner-inner")).Click();
            {
                var element = driver.FindElement(By.CssSelector(".col-md-4:nth-child(1) .filter-option-inner-inner"));
            ...
            {
                var element = driver.FindElement(By.CssSelector(".bs-placeholder .filter-option-inner-inner"));
                Actions builder = new Actions(driver);
                builder.MoveToElement(element).Perform();
            }
            Thread.Sleep(1000);
            ...
            {
                var element = driver.FindElement(By.CssSelector(".cke_editable"));
                js.ExecuteScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = '"+giaithuong+"'}", element);
            }
            driver.SwitchTo().DefaultContent();
            Thread.Sleep(1000);
