...
namespace SuaTinTuyenDung
{
    public class Tests
    {
        ...
        {
            string filePath = @"C:\Users\Hoang Phuc\Desktop\SuaTinTuyenDung\ExcelData\SuaTTD.xlsx";
        ...
        public void PostTTD(string username, string password, string tencv, string baccv, string loaicv, string mucluong, string chuyennganh, string diachi, string gioitinh, string address, string mota, string yeucau, string kynang, string quyenloi, string soluong, string thoigian)
        {
            ...
            Thread.Sleep(2000);
            driver.FindElement(By.XPath("//span[contains(text(),'Đang xét duyệt')]")).Click();
            Thread.Sleep(2000);
            driver.FindElement(By.CssSelector("a[href='/nha-tuyen-dung/TinTuyenDung/Edit/17']")).Click();
            Thread.Sleep(2000);
